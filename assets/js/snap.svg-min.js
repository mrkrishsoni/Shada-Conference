    ...
    var c = (function (b) {
      ...
      d = (function () {
        ...
        function e(a, b) {
          if (b) {
            if (
              ("#text" == a && (a = z.doc.createTextNode(b.text || "")),
              "string" == typeof a && (a = e(a)),
              "string" == typeof b)
            )
              return "xlink:" == b.substring(0, 6)
                ? a.getAttributeNS(W, b.substring(6))
                : "xml:" == b.substring(0, 4)
                ? a.getAttributeNS(X, b.substring(4))
                : a.getAttribute(b);
            for (var c in b)
              if (b[A](c)) {
                var d = B(b[c]);
                d
                  ? "xlink:" == c.substring(0, 6)
                    ? a.setAttributeNS(W, c.substring(6), d)
                    : "xml:" == c.substring(0, 4)
                    ? a.setAttributeNS(X, c.substring(4), d)
                    : a.setAttribute(c, d)
                  : a.removeAttribute(c);
              }
        ...
        function f(a, b) {
          return (
            (b = B.prototype.toLowerCase.call(b)),
            "finite" == b
              ? isFinite(a)
              : "array" == b &&
              ...
              : ("null" == b && null === a) ||
                (b == typeof a && null !== a) ||
                ("object" == b && a === Object(a)) ||
                L.call(a).slice(8, -1).toLowerCase() == b
          );
        }
        function h(a) {
          ...
          return (
            (a = a.replace(/(?:^|\s)(\w+)\(([^)]+)\)/g, function (a, c, d) {
              return (
                ...
                b.push(
                  "skewX" == c
                    ? ["m", 1, 0, E.tan(l(d[0])), 1, 0, 0]
                    : "skewY" == c
                    ? ["m", 1, E.tan(l(d[0])), 0, 1, 0, 0]
                    : [c.charAt(0)].concat(d)
                ),
                a
              );
        ...
        function p(a, b) {
          if (null == b) {
            ...
            (b = d._.rgTransform.test(b)
              ? B(b).replace(/\.{3}|\u2026/g, a._.transform || J)
              : n(b)),
        ...
        function q(a) {
          var b =
              (a.node.ownerSVGElement && y(a.node.ownerSVGElement)) ||
              (a.node.parentNode && y(a.node.parentNode)) ||
              d.select("svg") ||
              d(0, 0),
            c = b.select("defs"),
            e = null == c ? !1 : c.node;
        ...
        function u(a) {
          ...
          if (
            ...
            this.type in { g: 1, mask: 1, pattern: 1 })
          )
        ...
        function x(a, b) {
          ...
          if (a && "svg" == a.tagName) {
            ...
            (c = w("svg", z.doc.body)),
              e(c.node, { height: b, version: 1.1, width: a, xmlns: X });
          return c;
        }
        function y(a) {
          return a
            ? a instanceof u || a instanceof v
              ? a
              ...
              ? new x(a.contentDocument.getElementsByTagName("svg")[0])
              : new u(a)
            : a;
        }
        (d.version = "0.3.0"),
        ...
        (d._.$ = e),
          ...
          (d.getRGB = j(function (a) {
            ...
            if ("none" == a)
              return { r: -1, g: -1, b: -1, hex: "none", toString: bb };
            if (
              (!(P[A](a.toLowerCase().substring(0, 2)) || "#" == a.charAt()) &&
                (a = $(a)),
              !a)
            )
              return {
              ...
              ? (j[2] &&
                ...
                j[5]
                  ...
                  : ((b = G(E.round(b), 255)),
                    ...
                    j))
              : { r: -1, g: -1, b: -1, hex: "none", error: 1, toString: bb };
          }, d)),
        ...
        var $ = function (a) {
            var b =
                z.doc.getElementsByTagName("head")[0] ||
                z.doc.getElementsByTagName("svg")[0],
              c = "rgb(255, 0, 0)";
            return ($ = j(function (a) {
              if ("red" == a.toLowerCase()) return c;
              (b.style.color = c), (b.style.color = a);
              var d = z.doc.defaultView
                .getComputedStyle(b, J)
        ...
        (d._.svgTransform2string = n),
          ...
          (d._unit2px = s);
        z.doc.contains || z.doc.compareDocumentPosition
          ? function (a, b) {
        ...
        (d._.getSomeDefs = q),
          ...
          (d.selectAll = function (a) {
            for (
              var b = z.doc.querySelectorAll(a), c = (d.set || Array)(), e = 0;
              e < b.length;
              e++
            )
              c.push(y(b[e]));
          ...
          (function (a) {
              ...
              return function () {
                ...
                if (d.length) {
                  for (a && (b += ">"), e = 0, f = d.length; f > e; e++)
                    3 == d[e].nodeType
                      ? (b += d[e].nodeValue)
                      : 1 == d[e].nodeType && (b += y(d[e]).toString());
                  a && (b += "</" + this.type + ">");
                } else a && (b += "/>");
                return b;
              };
            ...
            (a.transform = function (a) {
              ...
              if (null == a) {
                for (
                  var c,
                    f = this,
                    g = new d.Matrix(this.node.getCTM()),
                    h = p(this),
                    i = [h],
                    k = new d.Matrix(),
                    l = h.toTransformString(),
                    m = B(h) == B(this.matrix) ? B(b.transform) : l;
                  "svg" != f.type && (f = f.parent());
              ...
              return (
                a instanceof d.Matrix ? (this.matrix = a) : p(this, a),
                this.node &&
            ...
            (a.addClass = function (a) {
              ...
              (a.toggleClass = function (a, b) {
                ...
                return (
                  (f = j.join(" ")), i != f && (h.className.baseVal = f), this
                );
              }),
              (a.clone = function () {
          ...
          (d.fragment = function () {
            for (
              var a = Array.prototype.slice.call(arguments, 0),
                b = z.doc.createDocumentFragment(),
                c = 0,
                e = a.length;
              e > c;
              c++
      ...
      d.plugin(function (a, c, d, e) {
        ...
        (f.image = function (b, c, d, e, f) {
          ...
          (f.path = function (a) {
            var b;
            return (
              g(a, "object") && !g(a, "array") ? (b = a) : a && (b = { d: a }),
              this.el("path", b)
            );
          }),
          (f.group = f.g =
          ...
          (f.use = function (a) {
            if (null != a) {
              ...
              return (
                a instanceof c &&
                  (a.attr("id") || a.attr({ id: ID() }), (a = a.attr("id"))),
          ...
          (function () {
            ...
            function g(a, c) {
              ...
              f.params.unshift(a),
                ...
                f.type != f.type.toLowerCase() &&
                  j(e.node, { gradientUnits: "userSpaceOnUse" });
              var g = f.stops,
                k = g.length,
                l = 0,
                m = 0;
              ...
              for (
                g[k].offset = g[k].offset || 100, d(k, g[k].offset), n = 0;
                k >= n;
                n++
              ) {
                var o = g[n];
            ...
            function h(b, f, g, h, i) {
              ...
              return (
                ...
                (k.addStop = d),
                (k.getBBox = e),
                null != f && j(k.node, { x1: f, y1: g, x2: h, y2: i }),
                k
              );
            }
            function i(b, f, g, h, i, k) {
              ...
              return (
                ...
                (l.addStop = d),
                (l.getBBox = e),
                null != f && j(l.node, { cx: f, cy: g, r: h }),
                null != i && null != k && j(l.node, { fx: i, fy: k }),
                l
              );
            }
            var j = a._.$;
            (f.gradient = function (a) {
              ...
              (f.toString = function () {
                ...
                return (
                  d.appendChild(e),
                  e.appendChild(f),
                  a._.$(f, { xmlns: "http://www.w3.org/2000/svg" }),
                  (b = e.innerHTML),
      ...
      d.plugin(function (a, c) {
        ...
        function e(b, c, e) {
          ...
          for (
            ...
            if (
              ...
              (k = c[p] || d(h)),
              h[0] != k[0] ||
                ("r" == h[0].toLowerCase() && (h[2] != k[2] || h[3] != k[3])) ||
                ("s" == h[0].toLowerCase() && (h[3] != k[3] || h[4] != k[4])))
            ) {
            ...
            for (
              n[p] = [], o[p] = [], f = 0, g = Math.max(h.length, k.length);
              g > f;
              f++
            )
        ...
        (k.stroke = k.fill = "colour"),
          ...
          b.on("snap.util.equal", function (b, c) {
            ...
            if ("d" == b || "path" == b)
              return (
                (d = a.path.toCubic(o, c)),
                { from: j(d[0]), to: j(d[1]), f: i(d[0]) }
              );
            if ("points" == b)
              return (
                (d = m(o).split(a._.separator)),
            ...
            return aUnit && aUnit == q
              ? { from: parseFloat(o), to: parseFloat(c), f: g(aUnit) }
